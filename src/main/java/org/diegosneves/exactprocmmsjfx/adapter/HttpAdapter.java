...
import org.diegosneves.exactprocmmsjfx.util.EnvLoaderUtil;
...
public abstract class HttpAdapter {
    ...
    protected HttpAdapter() {
        ...
        this.apiUrl = EnvLoaderUtil.getEnv("EXACTPRO_CMMS_API_URL");

        // Configura o GsonHttpMessageConverter manualmente
        GsonHttpMessageConverter gsonConverter = new GsonHttpMessageConverter();
        gsonConverter.setGson(new GsonBuilder().create());
        this.restTemplateSimpleWebClient.getRestTemplate().getMessageConverters().add(gsonConverter);
    }
}
